...
function replace_all_rel_by_abs(html){
 ...
 /*function processDOM(response, urlPath){
...
var url = document.getElementById('url').value.hexDecode();
var response = document.getElementById('body').value.hexDecode();
console.log(url);
console.log("http://ignore__"+url.hexEncode())

//response = replace_all_rel_by_abs(response)

var el = document.createElement( 'html' );
el.innerHTML = response;
console.log(el.getElementsByTagName( 'img' )); // Live NodeList of your anchor elements


//window.history.pushState({"html":response,"pageTitle":"test"},"", url0);
top.location.replace('data:text/html;charset=utf-8,' + encodeURIComponent(response))
...
//top.location.replace("http://ignore__/?url="+url.hexEncode()) //if there is no content to examine there could be a redirect
