...
x = fire_module(x, fire_id=2, squeeze=8, expand=16)
#x = fire_module(x, fire_id=3, squeeze=8, expand=32)
x = MaxPooling2D(pool_size=(3, 3), strides=(2, 2), name='pool3')(x)

x = fire_module(x, fire_id=4, squeeze=8, expand=32)
...
x = fire_module(x, fire_id=6, squeeze=8, expand=64)
#x = MaxPooling2D(pool_size=(3, 3), strides=(2, 2), name='poolsss')(x)
x = Dropout(0.2)(x)
...
#x = Dense(16)(x)
#x = Activation('relu', name="asdsasdcccdc")(x)
